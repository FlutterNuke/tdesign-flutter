...
## 🌈 0.2.5 `2025-09-12` 
### 🐞 Bug Fixes
- `TPopover`: 添加圆角属性自定义 @jflin19990707 ([#727](https://github.com/Tencent/tdesign-flutter/pull/727))
- `TForm`: 增加表单自定义背景颜色属性，按钮部分可为空 @jflin19990707 ([#730](https://github.com/Tencent/tdesign-flutter/pull/730))
- `TConfirmDialog`: 弹窗支持自定义宽度，按钮增加自定义样式属性 @jflin19990707 ([#724](https://github.com/Tencent/tdesign-flutter/pull/724))
- `TPicker`: 支持初始化和后续动态加载适量数据，修复卡顿问题@123dw-bot([#728](https://github.com/Tencent/tdesign-flutter/pull/728))
-  `TSideBar`增加自定义未选中颜色 @jflin19990707 ([#723](https://github.com/Tencent/tdesign-flutter/pull/723))
### 🚧 Others
- docs: 优化仓库大小 @RSS1102
...
## 🌈 0.2.4 `2025-08-14` 
### 🚀 Features
- `TUpload`: 支持设置多图间距和对其方式 @cyjaysong ([#677](https://github.com/Tencent/tdesign-flutter/pull/677))
- `TTreeSelect`: 新增自定义宽度和最大行数字段，修复第二级宽度固定，长文本溢出问题 @123dw-bot ([#694](https://github.com/Tencent/tdesign-flutter/pull/694))
- `TDropdownMenu`: 增加TDDropdownItemController，允许外部重置和更改下拉选项 @Luozf12345 ([#697](https://github.com/Tencent/tdesign-flutter/pull/697))
- `TStepper`:Stepper增加controller参数，可用于实时修改value @Luozf12345 ([#699](https://github.com/Tencent/tdesign-flutter/pull/699))

### 🐞 Bug Fixes
- `TIndexes`: 修复自定义索引无法响应点击事件 @epoll-j ([#692](https://github.com/Tencent/tdesign-flutter/pull/692))
- `TPopup`: 修复close方法触发两次bug @epoll-j ([#690](https://github.com/Tencent/tdesign-flutter/pull/690))
- `TSideBar`:修复TDSideBar组件初始化后children无法更新的问题 @Luozf12345 ([#698](https://github.com/Tencent/tdesign-flutter/pull/698))
...
## 🌈 0.2.3 `2025-07-09` 
### 🚀 Features
- `TPicker`: 支持切换时优先保持级联的选项值 @epoll-j ([#666](https://github.com/Tencent/tdesign-flutter/pull/666))
- `TTable`: 支持行默认选中 @ccXxx1aoBai ([#665](https://github.com/Tencent/tdesign-flutter/pull/665))
- `TCalendar`: 增加自定义日期单元格功能 @epoll-j ([#667](https://github.com/Tencent/tdesign-flutter/pull/667))
- `TForm`: 增加Form 表单组件 @shizhe2018 @SimonWuZY ([#620](https://github.com/Tencent/tdesign-flutter/pull/620))
- `TTable`: TTableCol属性配置分离，空数据配置分离 @ccXxx1aoBai ([#665](https://github.com/Tencent/tdesign-flutter/pull/665))
### 🐞 Bug Fixes
- `TTable`: 解决表头未选中图标显示问题，禁用状态下全选选中状态问题 @ccXxx1aoBai ([#665](https://github.com/Tencent/tdesign-flutter/pull/665))
- `TTable`: 表格空数据问题 @ccXxx1aoBai ([#671](https://github.com/Tencent/tdesign-flutter/pull/671))
- `TDialog`: 弹窗遮挡键盘问题 @jflin19990707 ([#669](https://github.com/Tencent/tdesign-flutter/pull/669))
- `TCollapse`: collapse demo页面名称修改 @jflin19990707 ([#670](https://github.com/Tencent/tdesign-flutter/pull/670))
- `TDropdownMenu`: 嵌套路由场景 弹窗位置计算错误 @hcanyz ([#648](https://github.com/Tencent/tdesign-flutter/pull/648))

## 🌈 0.2.2 `2025-06-13`

### 🚀 Features

- `TTable`: 支持表格行选择、自定义行高 @ccXxx1aoBai ([#594](https://github.com/Tencent/tdesign-flutter/pull/594))
- `TTreeSelect`: 支持局部多选 @epoll-j ([#587](https://github.com/Tencent/tdesign-flutter/pull/587))
- `TCell`: 支持自定义高度，底部分割线 @ccXxx1aoBai ([#611](https://github.com/Tencent/tdesign-flutter/pull/611))
- `TNoticeBar`: 支持自定义文字行数 @ccXxx1aoBai ([#611](https://github.com/Tencent/tdesign-flutter/pull/611))
- `TBottomTabBar`: TButtonBottomTabBar 中的 onTap 支持重复点击 @epoll-j @RSS1102([#586](https://github.com/Tencent/tdesign-flutter/pull/586))
- `TBottomTabBar`: 实现点击水波纹效果 @RSS1102 ([#626](https://github.com/Tencent/tdesign-flutter/pull/626))
- `TAvatar` 增加自定义BoxFit参数 @shizhe2018 ([#633](https://github.com/Tencent/tdesign-flutter/pull/633))

### 🐞 Bug Fixes

- `TDatePicker`: 修复时间选择器分钟级时间数据展示问题- 优化小时、分钟、秒的选择范围计算逻辑 @epoll-j ([#585](https://github.com/Tencent/tdesign-flutter/pull/585))
- `TSearchBar`: 支持设置onTapOutside回调 @cyjaysong ([#608](https://github.com/Tencent/tdesign-flutter/pull/608))
- `TDropdownMenu`:  支持修改选中icon颜色 @jflin19990707 ([#631](https://github.com/Tencent/tdesign-flutter/pull/631))
- `TTabBar`: fix:TBottomTabBarBasicType.iconText模式下，text icon 冲突问题 @jflin19990707 ([#628](https://github.com/Tencent/tdesign-flutter/pull/628))
- `TEmpty`: 支持操作按钮自定义样式 @jflin19990707 ([#624](https://github.com/Tencent/tdesign-flutter/pull/624))
- `TToast`: toast支持自定义文案 @jflin19990707 ([#625](https://github.com/Tencent/tdesign-flutter/pull/625))
- `TPopup`: 修改_measureChildHeight方法用于修复child无法修改弹窗高度 @Jzow ([#591](https://github.com/Tencent/tdesign-flutter/pull/591))
- `TCascader` 修改查询data数据为空状态处理 @shizhe2018 ([#635](https://github.com/Tencent/tdesign-flutter/pull/635))
...
## 🌈 0.2.0 `2025-05-08`
### 🚀 Features
- `TCellGroup`: 添加单元格组标题背景颜色`titleBackgroundColor`属性. @runoob-coder ([#539](https://github.com/Tencent/tdesign-flutter/pull/539))
- `TLink`: link参数链接对象`LinkObj`替换为`MessageLink`，调整`TLink`样式，新增点击回调； @runoob-coder ([#554](https://github.com/Tencent/tdesign-flutter/pull/554))
- `TBottomTabBar`: 新增自定义标题支持到步骤条组件 @RSS1102 ([#576](https://github.com/Tencent/tdesign-flutter/pull/576))
- `TSlider`: 添加滑块点击事件 `onTap` @RSS1102 ([#527](https://github.com/Tencent/tdesign-flutter/pull/527))
- `TCascader`: 添加右上角"确定"按钮，支持选择任意选项 @Luozf12345
- `ImageViewer`: 支持单张图片删除 @ccXxx1aoBai ([#581](https://github.com/Tencent/tdesign-flutter/pull/581))
- `TPopup`: 为Popup组件添加标题、左文本、右文本和关闭按钮自定义尺寸属性 @Jzow ([#582](https://github.com/Tencent/tdesign-flutter/pull/582))
- `TBottomTabBarTabConfig`: 添加长按 tab 触发事件`onLongPress` @RSS1102 ([#580](https://github.com/Tencent/tdesign-flutter/pull/580))

### 🐞 Bug Fixes
- `TFooter`: 修复页脚链接模式时内容溢出问题 @runoob-coder ([#554](https://github.com/Tencent/tdesign-flutter/pull/554))
- `TUpload`: 修复文件大小限制错误 @epoll-j ([#544](https://github.com/Tencent/tdesign-flutter/pull/544))
- `TImageViewer`: 增加Swiper组件属性透传，增加点击事件及部分样式属性，支持自定义按钮 @ccXxx1aoBai ([#561](https://github.com/Tencent/tdesign-flutter/pull/561))
- `TSlider`: 修复是胶囊类型且有区间时，滑块无法拖动到边缘以及数值和刻度展示问题 @qfish ([#567](https://github.com/Tencent/tdesign-flutter/pull/567))
- `TInput`: 修复非中文标签Input框宽度计算缺陷 @Jzow ([#564](https://github.com/Tencent/tdesign-flutter/pull/564))
- `TPopup`: 修复无法通过child中的height来修改弹出层高度 @Jzow ([#571](https://github.com/Tencent/tdesign-flutter/pull/571))
- `TDropdownMenu`: 修复特定情况下的单选失效 @1jialong ([#575](https://github.com/Tencent/tdesign-flutter/pull/575))
- `TToast`: 修复Toast多行文字不生效的问题 @Luozf12345
- `TPopup`: 修复Popup外层没有Scaffold时展示文字有横线的问题 @Luozf12345

###  🚧 Others
- `TFooter`: 重构 `TFooter` 组件；将 `LinkObj` 类移除，直接使用 `TLink` 类；移除了 `isWithUnderline` 参数，改为在 `TLink` 中设置链接样式； @runoob-coder ([#554](https://github.com/Tencent/tdesign-flutter/pull/554))



## 🌈 0.1.9 `2025-03-31`
### 🚀 Features
- `TProgress`: 新增`Progress 进度条`组件 @CORCTON ([#307](https://github.com/Tencent/tdesign-flutter/pull/307))
- `TMessage`: 新增`Message 全局提示`组件 @chendingya ([#316](https://github.com/Tencent/tdesign-flutter/pull/316))
- `TSkeleton`: 新增`Skeleton 骨架屏`组件 @Ezer015 ([#317](https://github.com/Tencent/tdesign-flutter/pull/317))
- `TFooter`: 新增`Footer 页脚`组件 @chendingya ([#224](https://github.com/Tencent/tdesign-flutter/pull/224))
- `TPopover`: 新增`Popover 弹出气泡`组件 @ccXxx1aoBai ([#435](https://github.com/Tencent/tdesign-flutter/pull/435))
- `TSwitch`: 添加自定义“开/关”字体大小 @shinyina ([#217](https://github.com/Tencent/tdesign-flutter/pull/217))
- `TDatePicker`: filterItems 参数添加，可自定义显示那些选项；itemBuilder 参数添加，用于自定义item @hkaikai ([#426](https://github.com/Tencent/tdesign-flutter/pull/426))
- `TDrawer`: 新建TDDrawerWidget组件，可用于Scaffold中的drawer属性 @hkaikai ([#445](https://github.com/Tencent/tdesign-flutter/pull/445))
- `TTable`: 自定义列返回当前行号 @ccXxx1aoBai ([#457](https://github.com/Tencent/tdesign-flutter/pull/457))
- `TUpload`: upload组件支持宽高设置和快速替换配置 @HubuHito ([#462](https://github.com/Tencent/tdesign-flutter/pull/462))
- `TButton`: 添加按钮图标位置属性 @epoll-j ([#463](https://github.com/Tencent/tdesign-flutter/pull/463))
- `TDropdownMenu`: 支持单选(multiple == false)模式下，分栏(optionsColumns > 1)展示选项 @hkaikai ([#502](https://github.com/Tencent/tdesign-flutter/pull/502))
- `TActionSheet`: 新增动作面板组件 @hkaikai ([#485](https://github.com/Tencent/tdesign-flutter/pull/485))
- `TPicker`: 增加customSelectWidget参数 @epoll-j ([#495](https://github.com/Tencent/tdesign-flutter/pull/495))
- `TSlider`: 增加修改滑轨颜色参数 @epoll-j ([#506](https://github.com/Tencent/tdesign-flutter/pull/506))
- `TCalendar`: 添加动画滚动日历选中值位置 @hkaikai ([#509](https://github.com/Tencent/tdesign-flutter/pull/509))
- `TStep`: 新增CustomContent参数支持Step的Content可以自定义内容 @Jzow ([#452](https://github.com/Tencent/tdesign-flutter/pull/452))
- `TTag`: 新增fixedWidth参数固定宽度属性，可自定义Tag的宽度，修复TextOverflow.ellipsis溢出title问题 @Jzow ([#496](https://github.com/Tencent/tdesign-flutter/pull/496))
- `TPopup`: 为底部浮层面板添加了边缘拖动控制 @Jzow ([#514](https://github.com/Tencent/tdesign-flutter/pull/514))
- `TBadge`: Badge设置封顶的数字值 @chendingya ([#302](https://github.com/Tencent/tdesign-flutter/pull/302))
- `TToast`：带图标类型支持设置文字行数 @ccXxx1aoBai ([#481](https://github.com/Tencent/tdesign-flutter/pull/481))


### 🐞 Bug Fixes
- `TRefreshHeader`: 升级easy refresh到最新版本，兼容v2和v3写法；交互同步其他移动端平台 @hkaikai ([#438](https://github.com/Tencent/tdesign-flutter/pull/438))
- `TCell`: 修复无默认样式情况下点击空白区域无反应问题；TCellStyle默认构造方法提供context参数，可以构建默认样式；完善demo自定义样式用法 @hkaikai ([#448](https://github.com/Tencent/tdesign-flutter/pull/448))
- `TTable`: 解决空数据图片无法显示问题 @ccXxx1aoBai ([#451](https://github.com/Tencent/tdesign-flutter/pull/451))
- `TTabBar`: labelStyle、unselectedLabelStyle支持自定义Label的文字大小 @hkaikai ([#453](https://github.com/Tencent/tdesign-flutter/pull/453))
- `TCalendar`: 修复定位到最后一个月时，无法定位问题 @hkaikai ([#449](https://github.com/Tencent/tdesign-flutter/pull/449))
- `TBottomTabBar`: 修复capsule类型无法设置背景色 @epoll-j ([#497](https://github.com/Tencent/tdesign-flutter/pull/497))
- `TCalendar`: 确定按钮添加国际化 @hkaikai ([#505](https://github.com/Tencent/tdesign-flutter/pull/505))
- `TUpload`: 新增onMaxLimitReached函数修复自定义处理文件数量超过最大限制的Bug @Jzow ([#474](https://github.com/Tencent/tdesign-flutter/pull/474))
- `TInput`: 新增_getTextWidth函数获取文本实际宽度和点击文本触发事件，修复buildNormalInput文本显示不全 @Jzow ([#475](https://github.com/Tencent/tdesign-flutter/pull/475))
- `TImage`: 移除自定义宽和自定义高必填，以及默认高度和宽度尺寸72约束，让布局系统自动计算高度 @Jzow ([#499](https://github.com/Tencent/tdesign-flutter/pull/499))
- `TConfirmDialog`: 新增布局约束和滚动支持动态计算最大高度，修复渲染失败Bug @Jzow ([#510](https://github.com/Tencent/tdesign-flutter/pull/510))
- `TDrawer`: 新增_deleteRouter()在close函数中的调用强制清除路由，修复关闭路由无法再次打开Bug @Jzow ([#512](https://github.com/Tencent/tdesign-flutter/pull/512))
- `TText`: 3.22鸿蒙版本text,组件不居中问题 @duleigiser ([#437](https://github.com/Tencent/tdesign-flutter/pull/437))
- `TAlertDialog`: fix 按钮样式没有铺满 @lvjs ([#460](https://github.com/Tencent/tdesign-flutter/pull/460))


### 🚧 Others
- `TSlider`: 演示代码拆分 @iamitis ([#245](https://github.com/Tencent/tdesign-flutter/pull/245))
...
## 🌈 0.1.8 `2024-12-30` 
### 🚀 Features
- `TUpload`: 新增Upload组件 @TingShine ([#405](https://github.com/Tencent/tdesign-flutter/pull/405))
...
- `Dialog`: TDialogButtonOptions新增属性字体大小 @shizhe2018 ([#381](https://github.com/Tencent/tdesign-flutter/pull/381))
...
- `TBottomTabBar`: 修复iconText模式，底部溢出2.5像素 @epoll-j ([#422](https://github.com/Tencent/tdesign-flutter/pull/422))
### 🚧 Others
...
## 🌈 0.1.7 `2024-10-16` 
### 🚀 Features
- `TNoticeBar`: 新增noticeBar组件 @ccXxx1aoBai ([#162](https://github.com/Tencent/tdesign-flutter/pull/162))
...
- `TDropdownMenu`: TDropdownItem新增tabBarFlex参数，控制宽度占比 @hkaikai ([#338](https://github.com/Tencent/tdesign-flutter/pull/338))
...
- `TDropdownMenu`: 优化menu显示文字超出显示省略号 @hkaikai ([#338](https://github.com/Tencent/tdesign-flutter/pull/338))
...
- `TBottomTabBar`:
  ...
  - add:TBottomTabBar支持外部设置currentIndex ([#110](https://github.com/Tencent/tdesign-flutter/issues/110))
- `TBadge`:
  - add: TBadge当值为0时角标显隐设置  @ccXxx1aoBai
- `TRadio`:
  - add: TRadio增加自定义背景色和文字颜色 @ccXxx1aoBai ([#135](https://github.com/Tencent/tdesign-flutter/issues/135))
  - add: 新增去掉左边边距API([#128](https://github.com/Tencent/tdesign-flutter/issues/128))
- `TCheckbox`:
  - add: TCheckbox增加自定义文字颜色
  - add: 新增去掉左边边距API
- `TImage`:
...
- `TSwitch`:
  - add: TSwitch 支持自定义"开/关"文案 ([#73](https://github.com/Tencent/tdesign-flutter/issues/73))
- `TDialog`:
...
- `TButton`:
  - fix: TButton点击禁用效果无效问题 ([#44](https://github.com/Tencent/tdesign-flutter/issues/44))
- `TInput`:
