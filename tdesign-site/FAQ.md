...
TDesign Flutter 0.1.5版本之后，可以通过重写TTextPaddingConfig的paddingRate和paddingExtraRate进行自定义适配,TTextPaddingConfig使用方法可参考TTextPage。如果kTextForceVerticalCenterEnable设为false也无法满足需求，则可以通过重写TTextPaddingConfig自定义适配主流机型。
