...
[t_badge_page.dart](https://github.com/Tencent/tdesign-flutter/blob/main/tdesign-component/example/lib/page/t_badge_page.dart)
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          child: TText(
            '单行标题',
            textColor: TTheme.of(context).fontGyColor1,
            font: TTheme.of(context).fontBodyLarge,
          ),
          color: Colors.white,
          height: 48,
