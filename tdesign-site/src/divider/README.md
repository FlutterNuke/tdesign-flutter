...
[t_divider_page.dart](https://github.com/Tencent/tdesign-flutter/blob/main/tdesign-component/example/lib/page/t_divider_page.dart)
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          TText(
            '文字信息',
            textColor: TTheme.of(context).fontGyColor1.withOpacity(0.9),
          ),
          const TDivider(
            width: 0.5,
            height: 12,
