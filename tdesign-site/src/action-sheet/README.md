  ...
  return TButton(
    ...
    onTap: () {
      TActionSheet.showGridActionSheet(context, items: [
        TActionSheetItem(label: '微信', icon: Image.asset('assets/img/td_action_sheet_1.png'), badge: const TBadge(TBadgeType.message, count: 'NEW')),
        TActionSheetItem(label: '朋友圈', icon: Image.asset('assets/img/td_action_sheet_2.png')),
        TActionSheetItem(label: 'QQ', icon: Image.asset('assets/img/td_action_sheet_3.png')),
        TActionSheetItem(label: '企业微信', icon: Image.asset('assets/img/td_action_sheet_4.png')),
        TActionSheetItem(label: '收藏', icon: const IconWithBackground(icon: TIcons.star), badge: const TBadge(TBadgeType.redPoint)),
        TActionSheetItem(label: '刷新', icon: const IconWithBackground(icon: TIcons.refresh)),
        TActionSheetItem(label: '下载', icon: const IconWithBackground(icon: TIcons.download), badge: const TBadge(TBadgeType.message, count: '8')),
        TActionSheetItem(label: '复制', icon: const IconWithBackground(icon: TIcons.queue)),
      ]);
    },
  );
}</pre>
