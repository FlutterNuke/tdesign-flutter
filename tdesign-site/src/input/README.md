...
[t_input_page.dart](https://github.com/Tencent/tdesign-flutter/blob/main/tdesign-component/example/lib/page/t_input_page.dart)
          ...
          rightBtn: Row(
            ...
            children: [
              Container(
                width: 0.5,
                height: 24,
                color: TTheme.of(context).grayColor3,
              ),
              const SizedBox(
                width: 16,
              ),
            ...
            child: Row(
              ...
              children: [
                ...
                _countdownTime > 0
                    ...
                    : TText(confirmText, textColor: TTheme.of(context).brandNormalColor),
              ],
            ),
          ),
          needClear: false,
    ...
    return Column(
      children: [
        TInput(
          ...
          rightWidget: TText('元', textColor: TTheme.of(context).fontGyColor1),
        ),
        const SizedBox(
          height: 16,
        )
...
<td-code-block panel="Dart">
  ...
  Widget _specialTypeNumber(BuildContext context) {
    return TInput(
      ...
      backgroundColor: Colors.white,
      textAlign: TextAlign.end,
      rightWidget: TText('个', textColor: TTheme.of(context).fontGyColor1),
    );
  }</pre>
