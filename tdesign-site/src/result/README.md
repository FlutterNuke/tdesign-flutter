...
[t_result_page.dart](https://github.com/Tencent/tdesign-flutter/blob/main/tdesign-component/example/lib/page/t_result_page.dart)
...
| theme | TResultTheme | TResultTheme.defaultTheme | 主题样式，定义了结果组件的视觉风格 |
