...
class THorizontalTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<THorizontalTabBar> createState() => _TDHorizontalTabBarState();
}
...
class _TDHorizontalTabBarState extends State<THorizontalTabBar> {
...
class THorizontalTabBarView extends StatefulWidget {
  ...
  @override
  State<THorizontalTabBarView> createState() => _TDHorizontalTabBarViewState();
}

class _TDHorizontalTabBarViewState extends State<THorizontalTabBarView> {
  TabController? _controller;
