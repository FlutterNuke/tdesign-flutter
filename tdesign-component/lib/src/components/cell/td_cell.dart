...
class _TDCellState extends State<TCell> {
  var _status = 'default';
  ...
  Widget build(BuildContext context) {
    ...
    final style = widget.style ?? TCellInherited.of(context)?.style ?? TCellStyle.cellStyle(context);
    final crossAxisAlignment = _getAlign();
    final color = _status == 'default' ? style.backgroundColor : style.clickBackgroundColor;
    ...
    return GestureDetector(
      ...
      onLongPress: widget.onLongPress != null && !disabled ? () => widget.onLongPress!(widget) : null,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(width: theme.spacer8,),
            Expanded(
              child: Container(
                alignment: Alignment.centerRight,
                child: Builder(builder: (context) {
                  if (widget.noteWidget != null) {
                    return widget.noteWidget!;
            ...
            if (widget.arrow ?? false) Icon(TIcons.chevron_right, size: 24, color: style.arrowColor),
          ],
        ),
      ),
    );
